...
class Page extends Action {
  ...
  protected function addAction() {
    if (isset($_POST['submit'])) {
      $page = new Pages();
      unset($_POST['submit']);
      $page->insere(array("nome" => $_POST['nome'], "status" => $_POST['status'], "url" => $_POST['url'], "conteudo" => $_POST['conteudo'], "titulo" => $_POST['titulo']));
    }

    $this->render();
  }

  protected function testeAction() {
    $this->render();
  }

  protected function cadastroAction() {
    $this->render();
  }

  protected function contatoAction() {
    $this->render();
  }

  protected function termosAction() {
    $this->render();
  }
